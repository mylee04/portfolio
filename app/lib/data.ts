...
export const projects = [
  ...
  },
  {
    ...
    techStack: ["React Native", "TypeScript", "Supabase", "Supabase Auth", "Whisper API (STT)", "PostHog", "Voice Recording"],
    image: "/images/projects/3dots.png",
    status: "Active",
  ...
  },
  {
    ...
    techStack: ["React Native", "TypeScript", "Supabase", "Supabase Auth", "Whisper API (STT)", "PostHog", "PDF Generation"],
    image: "/images/projects/3dots.png",
    status: "Completed",
